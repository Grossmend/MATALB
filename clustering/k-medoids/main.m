...
% кластеризация k-medoid, просто запустить файл, предварительно добавив в
% 
%   for x = 1:10
%       disp(x)
%   end
% 
% каталог функцию "k_medoids.m"
...
for i = 1:numberVariant
    ...
    % input
    % k - кол-во кластеров
    % dist - матрица расстояний между точками
    
    % output
    % distrib - разбиение на кластеры (индексация такая же как у точек)
